        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', gap: '4rem', marginBottom: '4rem' }}>
          ...
          <div style={{ flex: '1 1 350px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.85rem', color: '#686a78' }}>
              <span>이메일 문의: <a href="mailto:seungho7-1@naver.com" style={{ color: '#8a8e9e', textDecoration: 'none', transition: 'color 0.2s' }} onMouseOver={(e)=>e.target.style.color='#fff'} onMouseOut={(e)=>e.target.style.color='#8a8e9e'}>seungho7-1@naver.com</a></span>
